...
class UpcomingMoviesDetailsScreen extends StatelessWidget {
  const UpcomingMoviesDetailsScreen({super.key, required this.index});
  final int index;
  @override
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    upcomingMovies[index].movieCategory,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: 13,
                                      fontWeight: FontWeight.w400,
