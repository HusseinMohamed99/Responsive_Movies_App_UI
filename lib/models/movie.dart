...
var newMovies = [
  Movie(
    ...
    movieCastName: ['Tom Holland', 'Zendaya', 'Benedict Cumberbatch'],
  ),
  Movie(
  ...
  Movie(
    ...
    movieCastName: ['Gemma Chan', 'Richard Madden', 'Angelina Jolie'],
  ),
];
...
var upcomingMovies = [
  Movie(
    ...
    movieCastName: ['Jason Momoa', 'Amber Heard', 'Willem Dafoe'],
  ),
  Movie(
    movieName: 'Batman',
    ...
    movieCastName: ['Robert Pattinson', 'Zoë Kravitz', 'Jeffrey Wright'],
  ),
  Movie(
    ...
    movieCastName: ['Ben Schwartz', 'Idris Elba', 'Colleen O\'Shaughnessey'],
  ),
];
